...
// import clouds_new from "@/assets/img/legends/clouds_new.jpg";
// import precipition_new from "@/assets/img/legends/precipitation_new.jpg";
// import temp_new from "@/assets/img/legends/temp_new.jpg";
// import wind_new from "@/assets/img/legends/wind_new.jpg";
...
//
//         //@ts-ignore
//         const url = me.getOpenWeather2TileURL(selectedOption.op);
//         // const url = me.getOpenWeatherTileURL(selectedOption.layer_name)
//         // console.log(url)
//         let layer: Tile<XYZ> = new Tile({
//             // @ts-ignore
...
//
//
//         me.weatherLayers[layer_name] = new Vector({
