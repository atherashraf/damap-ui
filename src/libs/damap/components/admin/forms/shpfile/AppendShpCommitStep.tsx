...
import type { ICommitAppendPayload, IPreviewAppendPayload } from "@damap/components/admin/forms/shpfile/appendTypes";
                    ...
                    <>
                        ...
                        <Grid size={{ xs: 12 }}>
                            <Paper sx={{ p: 1.5 }}>
                                ...
                                <Typography variant="body2">
                                    <strong>Mapped Fields:</strong> {Object.keys(props.finalMapping).length}
                                </Typography>
                                <Typography variant="body2">
