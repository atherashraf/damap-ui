...
import LayerCategoryControl, { ILayerCategory } from "@damap/components/admin/forms/LayerCategoryControl";
import AddLayerCategoryForm from "@damap/components/admin/forms/AddLayerCategoryForm";
