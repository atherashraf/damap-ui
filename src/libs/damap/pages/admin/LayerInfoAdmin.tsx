 ...
 * --------
 * ```tsx
 * import LayerInfoAdmin from "@damap/components/admin/LayerInfoAdmin";
 *
...
import ChangeList, { ChangeListHandle } from "@damap/components/admin/ChangeList";
import { Action } from "@damap/components/admin/ChangeListToolbar";
import DASnackbar, { DASnackbarHandle } from "@damap/components/base/DASnackbar";
import DAFullScreenDialog, { DAFullScreenDialogHandle } from "@damap/components/base/DAFullScreenDialog";
import MapApi, { MapAPIs } from "@damap/api/MapApi";
import AddRasterLayerInfo from "@damap/components/admin/forms/AddRasterLayerInfo";
import AddVectorLayerInfo from "@damap/components/admin/forms/AddVectorLayerInfo";
import AddURLLayerInfo from "@damap/components/admin/forms/AddURLLayerInfo";
